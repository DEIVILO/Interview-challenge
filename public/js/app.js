...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var registrationForm = document.querySelector('#customer-registration-form');
  ...
  registrationForm.addEventListener('submit', function (event) {
    ...
    var confirmPassword = document.querySelector('#password_confirmation').value;
  ...
  formFields.forEach(function (field) {
    field.addEventListener('input', function () {
      var id = field.getAttribute('id'); // Get the field's ID
